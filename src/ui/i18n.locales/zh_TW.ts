...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.abilities.dash.description": "向前衝刺，使移動速度提高 50%，持續 15 秒。僅限獵豹形態。",
  "entities.abilities.pounce.name": "撲擊",
  "entities.abilities.pounce.description": "一個潛行開場技，昏迷目標 2 秒。獎勵 1 個連擊點。僅限獵豹形態。",
  ...
  "entities.abilities.tigers_fury.description": "使攻擊強度提高 40，持續 6 秒。僅限獵豹形態。",
  "entities.abilities.rip.name": "割裂",
  "entities.abilities.rip.description": "終結技，在 12 秒內造成流血傷害。消耗連擊點。僅限獵豹形態。",
  ...
  "entities.dungeons.nythraxis_crypt.leaveText": "你回到 Thornpeak 的寒冷空氣中。",
  ...
  "entities.quests.q_nythraxis_graves.text": "我以前見過這些標記，就在北方戰場周圍的三座舊墳上。阿爾德倫隊長葬在東側高地，馬爾里克大祭司在中央破路旁，皇家刺客沃斯則在西側峭壁邊。觸碰每座墳墓並傾聽，{playerName}。死者或許記得生者遺忘的事。",
  ...
  "entities.quests.q_ledger_reedwater.completion": "這樣能讓那些咕嚕作響的惡魔離我的漁網一季了。告訴元帥，湖面又恢復寧靜了。",
  "entities.quests.q_ledger_reedwater.objectives.0.label": "泥鰭潛伏者已擊殺",
  "entities.quests.q_ledger_reedwater.text": "赤溪派你來的？很好，我這把老骨頭再也涉不過淺灘了。泥鰭已經悄悄爬回了蘆葦水域，而且比以往更加大膽。把牠們疏減一下：8隻泥鰭潛伏者，還有，當心深水。",
  "entities.quests.q_ledger_reedwater.title": "蘆葦水域巡邏",
  "entities.quests.q_ledger_silk.completion": "黑暗中少了八隻吐絲的傢伙。樹林呼吸得更順暢了，我也是。",
  "entities.quests.q_ledger_silk.objectives.0.label": "網木潛伏者已擊殺",
  "entities.quests.q_ledger_silk.text": "名冊也把東邊的樹林劃為守護的轄地。網木潛伏者每週都吐得更密了，上個趕集日有個孩子走得太近，我們把她割下來時她已經奄奄一息。趁牠們完全佔據樹林之前，擊殺8隻網木潛伏者。",
  "entities.quests.q_ledger_silk.title": "蛛絲與毒液",
  "entities.quests.q_ledger_teeth.completion": "十頭狼，黃昏的道路又屬於我們了。名冊對你更友善了。",
  "entities.quests.q_ledger_teeth.objectives.0.label": "森林狼已擊殺",
  "entities.quests.q_ledger_teeth.text": "狼群已經摸清了巡邏路線，牠們在黃昏時出擊，那時光線昏暗，落單的旅人就是易得的獵物。打散牠們，{playerName}。擊殺10頭森林狼，讓狼群學個新教訓。",
  "entities.quests.q_ledger_teeth.title": "黑暗中的尖牙",
  "entities.quests.q_ledger_toll.completion": "八名盜匪受到了懲處。風聲已經傳開了，這條收費路有了新的看守者，而他不收銀錢，他取人頭。",
  "entities.quests.q_ledger_toll.objectives.0.label": "谷地強盜已伏法",
  "entities.quests.q_ledger_toll.text": "東南的丘陵成了盜匪的收費路，他們搶劫任何輕裝出行的傻子。名冊上對他們每一個都標了賞金。對8名谷地強盜執行東溪的正義。",
  "entities.quests.q_ledger_toll.title": "攔路強盜的買路錢",
